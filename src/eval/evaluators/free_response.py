...
class FreeResponsePipeline:
    ...
    def run(
        ...
        *,
        ...
        cot_prompts = [cot_prompt_template.replace("<Q>", record.question) for record in records]
        ...
        for idx, record in enumerate(records):
            ...
            prompt = final_answer_template.replace("<Q>", cot_prompts[idx]).replace("<COT>", cot_text)
